...
#define CONFIG_MMC_SUNXI_SLOT		0     /* modify by cjcheng for display_param */ /* which mmc slot to use, could be 0,1,2,3 */
#define CONFIG_MMC_SUNXI_USE_DMA
#if 1/* add by cjcheng for display_param */
...
#endif/* add by cjcheng for display_param */
#define CONFIG_DOS_PARTITION
#define CONFIG_AUTO_UPDATE_ENV   /* add by cjcheng for display_param */
/*
 * Size of malloc() pool
